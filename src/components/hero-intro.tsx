...
// Static hero. Was a motion/react staggered intro; motion runtime broke
// rendering on the Next 16 / React 19 stack so this renders directly.
export function HeroIntro({
  ...
  return (
    <section className="mb-28 flex flex-col items-start">
      <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-brand-400/20 bg-brand-400/5 px-3 py-1 text-xs font-medium uppercase tracking-wider text-brand-300">
      ...
      <div className="flex flex-wrap items-center gap-4">
        {hasSession ? (
          <Link
            href="/app"
            className="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-6 py-3.5 text-base font-semibold text-[#0a0a0a] shadow-[0_0_40px_-12px_rgba(99,210,151,0.6)] transition hover:bg-brand-400"
          >
            Open Tunjuk →
          </Link>
        ) : (
